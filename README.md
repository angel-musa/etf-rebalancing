...
## Resume Bullet Point
* "Implemented data pipelines benchmarking ETFs and portfolio holdings against sector indices, calculating rolling returns, volatility, and correlations to identify relative underperformance and inform rebalancing decisions."

## Interview Explanation
* **Interviewer**: "Tell me about this ETF Portfolio Analytics Engine."
* **You**: "I built this application to simulate a real-world wealth management tool. It pulls live market data via `yfinance` and calculates critical risk-adjusted metrics like Sharpe and Beta. The core feature is its signal generator—instead of just showing charts, it actually recommends actions (Review, Increase, Hold) based on a quantitative ruleset analyzing 60-day rolling performance and volatility versus a benchmark. I designed it with a clean, minimal interface using Streamlit and Plotly to ensure the data is front-and-center and easily digestible for a portfolio manager."